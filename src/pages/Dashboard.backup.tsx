...
function Dashboard() {
  ...
  // Componente para exibir cartões de análise de saúde
  const HealthAnalysisCards = () => {
    return (
      <div className="mb-8">
        <h2 className="text-xl font-bold mb-4">Análises de Saúde</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="bg-white dark:bg-gray-800 shadow-sm">
            <CardHeader>
              <div className="flex items-center gap-2">
                <FileText className="h-5 w-5 text-teal-600" />
                <CardTitle>Exames e Análises</CardTitle>
              </div>
              <CardDescription>Upload e análise de exames</CardDescription>
            </CardHeader>
            <CardContent>
              <Button className="w-full" asChild>
                <Link to="/profile/exams">Ver meus exames</Link>
              </Button>
            </CardContent>
          </Card>
  ...
  const SupplementationCard = () => {
    return (
      <div className="mb-8">
        <SupplementTracker className="h-full" />
      </div>
    );
  };

  const HealthSupportCards = () => {
    return (
