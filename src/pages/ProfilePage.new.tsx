...
// Interface simplificada com todos os campos necessários
                      ...
                      <Tabs defaultValue="personal" className="w-full">
                        ...
                        <TabsContent value="health" className="mt-4 space-y-4">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                              <h3 className="text-lg font-medium">Preocupações de Saúde</h3>
                              <div className="mt-2 border rounded-md p-4">
                                <p className="text-sm text-muted-foreground">
                                  {profile?.healthConcernsText || 'Nenhuma preocupação informada'}
                                </p>
                              </div>
                            </div>
                            ...
                            <div>
                              <h3 className="text-lg font-medium">Suplementos</h3>
                              <div className="mt-2 border rounded-md p-4">
                                <p className="text-sm text-muted-foreground">
                                  {profile?.supplementsText || 'Nenhum suplemento informado'}
                                </p>
                                {profile?.supplementsFrequency && (
                                  <div className="mt-2">
                                    <p className="text-sm font-medium">Frequência</p>
                                    <p className="text-sm text-muted-foreground">{profile.supplementsFrequency}</p>
                                  </div>
                                )}
                              </div>
                            </div>
