            ...
            {analysisResult ? (
              <div className="mt-8 border-t border-slate-200 dark:border-slate-800 pt-6 space-y-6">
                ...
                {analysisResult.values && analysisResult.values.length > 0 && (
                  <div>
                    <h3 className="text-lg font-semibold mb-2">Valores Encontrados</h3>
                    <div className="space-y-2">
                      {analysisResult.values.map((item: any, index: number) => (
                        <div key={index} className="p-3 border rounded-md flex flex-wrap justify-between gap-2 items-center">
